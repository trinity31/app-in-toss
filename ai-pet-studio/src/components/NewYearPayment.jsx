...
import { NEWYEAR_PRODUCT_SKU } from '../config/const'
import { usePendingOrderStorage } from '../hooks/usePendingOrderStorage'

const CARD_TYPE_LABELS = {
  'new-year-card-cat-korea': '한국 고양이 연하장',
  'new-year-card-dog-korea': '한국 강아지 연하장',
  'new-year-card-cat-japan': '일본 고양이 연하장',
  'new-year-card-dog-japan': '일본 강아지 연하장',
  'new-year-card-cat-china': '중국 고양이 연하장',
  'new-year-card-dog-china': '중국 강아지 연하장',
  'new-year-card-cat-korea-male': '한국 고양이 연하장 (남아)',
  'new-year-card-cat-korea-female': '한국 고양이 연하장 (여아)',
  'new-year-card-dog-korea-male': '한국 강아지 연하장 (남아)',
  'new-year-card-dog-korea-female': '한국 강아지 연하장 (여아)',
}
