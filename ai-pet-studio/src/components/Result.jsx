...
export default function Result({ images = [], failedStyles = [], onRetryFailed, onSave, onSaveAll, onRetry, hasPendingOrder, onRestore, onDismissPending, error, onDismissError }) {
        ...
        <div style={styles.header}>
          ...
          <p style={styles.subtitle}>
            {failedStyles.length > 0
              ...
              : `우리 아이의 ${images.length}가지 특별한 모습이에요`}
          </p>
